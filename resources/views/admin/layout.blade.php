...
<div class="wrapper">
  ...
  <a href="{{ route('dashboard') }}" class="logo">
      ...
      <span class="logo-mini">PNC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">PNC</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>👮 Policia Nacional Civil &copy; Desarrollado por: <a href="mailto:alextello1@hotmail.com">Edwin Tello</a>.</strong> Derechos reservados. V0.5
  </footer>
